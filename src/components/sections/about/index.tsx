                ...
                <Col md={6} xs={12}>
                    ...
                    <div>
                        <div>
                            ...
                            <p> I have completed Bachelor's degree in Information Technology at INDUSTRIAL UNIVERSITY OF HCM CITY (IUH).</p>
                        </div>
                    </div>
                    <div>
                                    ...
                                    <div className="experience-container">
                                        ...
                                        <div className="details">
                                            ...
                                            <div className="info">
                                                ...
                                                <p className="company">INDUSTRIAL UNIVERSITY OF HCM CITY (IUH)</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
